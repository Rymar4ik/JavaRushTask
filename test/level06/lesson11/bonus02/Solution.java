...
public class Solution
{
    ...
    public static class Cat
    {
        ...
        public String toString()
        {
            ...
            else if (parentWoman == null)
                return "Cat name is " + name + ", no mother" + ", father is " + parentMan.name;
            else if (parentMan == null)
                return "Cat name is " + name + ", mother is " + parentWoman.name + ", no father";
            else
                return "Cat name is " + name +  ", mother is " + parentWoman.name + ", father is " + parentMan.name ;
        }
    }
