...
public class Solution
{
    ...
    {
       for ( Apartament s : apartaments){
           if(s instanceof Apt1Room){
               ((Apt1Room) s).clean1Room();
           }
           else if(s instanceof Apt2Room){
               ((Apt2Room) s).clean2Rooms();
           }
           else ((Apt3Room)s ).clean3Rooms();
       }
    }
