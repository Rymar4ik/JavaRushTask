...
2.2. Любой текст должен не, а затем сам текст. Пример: [Ivanov:Наачинаться с фамилии игрока (метод getName()), потом следовать двоеточичало игры].
        ...
        public void run() {
                try {
                    for (int i = 0; i < rating ; i++) {
                        System.out.println(currentThread().getName() + ":" + OnlineGame.steps.get(i));
